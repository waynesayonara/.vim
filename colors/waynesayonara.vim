...
let g:colors_name = "waynesayonara"
...
" Search {{{1
hi IncSearch cterm=UNDERLINE ctermfg=Black ctermbg=brown gui=UNDERLINE guifg=Black guibg=#FFADFD
hi Search term=reverse cterm=UNDERLINE ctermfg=Black ctermbg=brown gui=NONE guifg=Black guibg=#FFADFD
...
" Split area {{{1
hi StatusLine term=BOLD,reverse cterm=NONE ctermfg=Yellow ctermbg=DarkGray gui=BOLD guibg=#929292 guifg=white
hi StatusLineNC gui=NONE guibg=#929292 guifg=#E9E9F4
...
" Cursor {{{1
hi Cursor       gui=none guifg=black guibg=#6BFF6D
...
" 00C226
hi Number   term=UNDERLINE ctermfg=red gui=NONE guifg=#E429FF
